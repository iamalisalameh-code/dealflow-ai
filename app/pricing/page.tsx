  ...
  return (
    <>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, height: 64, background: scrolled ? 'rgba(255,255,255,0.85)' : 'transparent', backdropFilter: scrolled ? 'blur(20px)' : 'none', borderBottom: scrolled ? '1px solid rgba(0,0,0,0.06)' : 'none', transition: 'all 0.3s', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 48px' }}>
        <div onClick={() => window.location.href = '/landing'} style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
          {[['How it works', '/how-it-works'], ['Pricing', '/pricing'], ['Landing', '/landing']].map(([label, href]) => (
      ...
      {/* FOOTER */}
      <footer style={{ padding: '36px 48px', background: '#1d1d1f', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }} onClick={() => window.location.href = '/landing'}>
        ...
        <div style={{ display: 'flex', gap: 28 }}>
          {[['Landing', '/landing'], ['How it works', '/how-it-works'], ['Sign in', '/login']].map(([label, href]) => (
